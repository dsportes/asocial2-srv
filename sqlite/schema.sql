...
CREATE INDEX IF NOT EXISTS "CREDENTIAL_userId" ON "CREDENTIAL" ( "userId" );
CREATE INDEX IF NOT EXISTS "CREDENTIAL_roles" ON "CREDENTIAL" ( "roles" );

CREATE TABLE IF NOT EXISTS "CREDENTIAL@userId" (
  "org" TEXT,
  "pk" TEXT,
  "v" INTEGER,
  "col" TEXT,
  "ttl" INTEGER,
PRIMARY KEY(org, pk));
CREATE INDEX IF NOT EXISTS "CREDENTIAL@userId_org" ON "CREDENTIAL" ( "org" );
CREATE INDEX IF NOT EXISTS "CREDENTIAL@userId_v" ON "CREDENTIAL" ( "v" );
CREATE INDEX IF NOT EXISTS "CREDENTIAL@userId_col" ON "CREDENTIAL" ( "col" );
CREATE INDEX IF NOT EXISTS "CREDENTIAL@userId_ttl" ON "CREDENTIAL" ( "ttl" )  WHERE "ttl" > 0;
...
CREATE TABLE IF NOT EXISTS "INVITATION@major" (
  "org" TEXT,
  "pk" TEXT,
  "v" INTEGER,
  "col" TEXT,
  "ttl" INTEGER,
PRIMARY KEY(org, pk));
CREATE INDEX IF NOT EXISTS "INVITATION@major_org" ON "INVITATION" ( "org" );
CREATE INDEX IF NOT EXISTS "INVITATION@major_v" ON "INVITATION" ( "v" );
CREATE INDEX IF NOT EXISTS "INVITATION@major_col" ON "INVITATION" ( "col" );
CREATE INDEX IF NOT EXISTS "INVITATION@major_ttl" ON "INVITATION" ( "ttl" )  WHERE "ttl" > 0;


CREATE TABLE IF NOT EXISTS "INVITATION@majorminor" (
  "org" TEXT,
  "pk" TEXT,
  "v" INTEGER,
  "col" TEXT,
  "ttl" INTEGER,
PRIMARY KEY(org, pk));
CREATE INDEX IF NOT EXISTS "INVITATION@majorminor_org" ON "INVITATION" ( "org" );
CREATE INDEX IF NOT EXISTS "INVITATION@majorminor_v" ON "INVITATION" ( "v" );
CREATE INDEX IF NOT EXISTS "INVITATION@majorminor_col" ON "INVITATION" ( "col" );
CREATE INDEX IF NOT EXISTS "INVITATION@majorminor_ttl" ON "INVITATION" ( "ttl" )  WHERE "ttl" > 0;
